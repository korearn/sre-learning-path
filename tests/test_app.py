...
def test_analizar_niveles_log():
    ...
    assert resultado['ERROR'] == 1, f"Debería contar 1 ERROR, obtuvo {resultado['ERROR']}"
    assert resultado['WARNING'] == 1, f"Debería contar 1 WARNING, obtuvo {resultado['WARNING']}"
    assert resultado['DEBUG'] == 0, f"Debería contar 0 DEBUG, obtuvo {resultado['DEBUG']}"
